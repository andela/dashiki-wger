...
class WorkoutSessionDeleteView(
        WgerDeleteMixin, LoginRequiredMixin, DeleteView):
    '''
    ...
    def get_context_data(self, **kwargs):
        ...
        context = super(
            WorkoutSessionDeleteView, self).get_context_data(**kwargs)
        context['form_action'] = reverse(
            'manager:session:delete', kwargs={'pk': self.object.id,
                                              'logs': logs})
