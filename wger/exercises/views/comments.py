...
class ExerciseCommentEditView(WgerFormMixin,
    ...
    def get_context_data(self, **kwargs):
        context = super(
            ExerciseCommentEditView, self).get_context_data(**kwargs)
...
class ExerciseCommentAddView(WgerFormMixin,
    ...
    def form_valid(self, form):
        form.instance.exercise =\
            Exercise.objects.get(pk=self.kwargs['exercise_pk'])
    ...
    def get_context_data(self, **kwargs):
        ...
        '''
        context = super(
            ExerciseCommentAddView, self).get_context_data(**kwargs)
        context['form_action'] =\
            reverse('exercise:comment:add',
