...
urlpatterns = [
    url(r'^',
        include(patterns_gym, namespace="gym")),
    url(r'^config/',
        include(patterns_gymconfig, namespace="config")),
    url(r'^admin-config/',
        include(patterns_adminconfig, namespace="admin_config")),
    url(r'^user-config/',
        include(patterns_userconfig, namespace="user_config")),
    url(r'^notes/',
        include(patterns_admin_notes, namespace="admin_note")),
    url(r'^document/',
        include(patterns_documents, namespace="document")),
    url(r'^contract/',
        include(patterns_contracts, namespace="contract")),
    url(r'^contract-type/',
    ...
    url(r'^export/',
        include(patterns_export, namespace="export")),
]
